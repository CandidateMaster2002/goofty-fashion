  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-stone-600 mt-2">Browse our curated selection of fine garments.</p>
      </div>
        ...
        <main className="lg:col-span-3">
          {filteredItems.length > 0 ? (
            ...
            <div className="text-center py-20">
              <p className="text-xl text-stone-600">No products match your filters.</p>
            </div>
          )}
        </main>
      </div>
